                  ...
                  {components.map((component, index) => (
                    <tr key={component.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-600">
                        ...
                        {component.warranty && (
                          <span className="text-xs text-gray-500"> • {component.warranty} warranty</span>
                        )}
                      </td>
                      <td className="px-4 py-3 text-sm text-gray-600 text-center">{component.quantity}</td>
                      <td className="px-4 py-3 text-sm text-gray-600 text-right">₹{component.price.toLocaleString('en-IN')}</td>
